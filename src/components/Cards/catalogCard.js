...
import {getCatalog, getArtwork} from '../../services/catalogService';
import {
  setCatalog,
  setPage,
  setLimit,
...
const CatalogCards = ({catalogs, viewType, page, limit}) => {
  ...
  const renderHeader = () => (
    <View>
      ...
      <Text style={styles.titleHeader2}>Catalog</Text>
    </View>
  );
  ...
  return (
    <SafeAreaView>
      <View style={styles.buttonLike}>
        <TouchableOpacity onPress={() => dispatch(setScreen('Like'))}>
